      ...
      <div className="container mx-auto px-2 sm:px-4 py-2 sm:py-3 relative z-10">
        <div className="flex justify-end items-center gap-3">
          ...
          <motion.button
            ...
            className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-white bg-red-400/80 backdrop-blur-sm hover:bg-red-500/80 rounded-lg transition-all duration-200 border border-white/20 shadow-lg"
          ...
          <div className="flex items-center">
            ...
            <div className="relative">
              <button 
                className="flex items-center gap-2 p-2 rounded-xl bg-white/20 hover:bg-white/30 backdrop-blur-md transition-all duration-300 shadow-lg border border-white/20"
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <p className="text-sm font-medium text-white leading-none truncate max-w-32">
                    {user?.email?.split('@')[0] || 'User'}
                  </p>
                  <p className="text-xs text-white/80 leading-none mt-0.5">
              ...
              <AnimatePresence>
                {isUserMenuOpen && (
                  <motion.div 
                    className="absolute right-0 mt-2 w-56 sm:w-64 bg-gradient-to-br from-primary-400/90 via-accent-400/90 to-secondary-400/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/30 py-2 z-50"
                  ...
                  >
                    ...
                    <div className="px-4 py-3 border-b border-white/20">
                      ...
                      <p className="text-xs text-white/80 mt-1">Your AI companion is here for you</p>
                    </div>
                    ...
                    <div className="px-4 py-3 border-b border-white/20">
                      <div className="grid grid-cols-3 gap-2 sm:gap-3 text-center">
                        <div>
                          <div className="text-base sm:text-lg font-bold text-white">7</div>
                        ...
                        <div>
                          <div className="text-base sm:text-lg font-bold text-white">3</div>
                    ...
                    <div className="py-1">
                      ...
                      <button
                        onClick={handleLogout}
                        className="w-full text-left px-4 py-3 text-sm text-white hover:bg-white/20 flex items-center gap-3 transition-colors"
                      >
                        <LogOut className="h-4 w-4" />
                        Sign Out
                      </button>
