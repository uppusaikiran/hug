...
const Layout = () => {
  return (
    <div className="flex h-screen bg-gradient-to-br from-neutral-50 via-primary-50/30 to-accent-50/20 relative overflow-hidden">
      ...
      <div className="hidden md:block w-64 bg-gradient-to-br from-primary-100/90 via-accent-100/90 to-secondary-100/90 backdrop-blur-md border-r border-white/20 shadow-lg relative z-10">
        <Sidebar />
      </div>

      <div className="flex-1 flex flex-col overflow-hidden relative z-10">
        {/* Navbar with gradient background */}
        <div className="bg-gradient-to-r from-primary-100/90 via-accent-100/90 to-secondary-100/90 border-b border-white/20 shadow-lg backdrop-blur-md relative z-20">
          <Navbar />
        </div>
